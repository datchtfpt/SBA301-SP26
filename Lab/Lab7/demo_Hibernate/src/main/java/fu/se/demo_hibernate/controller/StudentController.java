...
import fu.se.demo_hibernate.service.StudentService;
...
public class StudentController implements Initializable {
    ...
    private void handleUpdateStudent() {
        try {
            ...
            if (selectedStudent == null) {showAlert(Alert.AlertType.WARNING, "Cảnh báo", "Vui lòng chọn một sinh viên để cập nhật.");
                return;
            }
